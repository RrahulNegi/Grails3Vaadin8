...
import hello.world.CustomerService
...
class CustomerForm extends FormLayout {
    ...
    void save() {
        println(customer.getFirstName())
        println("objjjjjjjjj "+customerService)
        println(myUI +"::"+myUI.contactService)
